 ...
 * @subpackage Cookie_Notice/admin
 */
...
class Cookie_Notice_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/cookie-notice-admin.js', array( 'jquery', 'wp-color-picker'), $this->version, false );

	}

	/**
	 * Add Admin Menu For Notice
	 *
	 * @since    1.0.0
	 */
	...
	*/
	...
	public function display_plugin_setup_page() {
		include_once 'partials/cookie-notice-admin-display.php';
	}
